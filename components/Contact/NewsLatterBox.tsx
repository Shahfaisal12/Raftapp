    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        ...
        <input
          type="submit"
          value="Subscribe"
          className="shadow-submit dark:shadow-submit-dark mb-5 flex w-full cursor-pointer items-center justify-center rounded-sm bg-primary p-3 text-base font-medium text-white duration-300 hover:bg-primary/90"
        />
